...
INSERT INTO issued(issued_id, issued_member_id, issued_book_name, issued_date, issued_book_isbn, issued_emp_id) 
VALUES
...
b.isbn,
b.book_title,
count(ist.issued_id) as issed_number
from books as b
JOIN 
issued as ist
...
SELECT *
FROM member
WHERE reg_date >= CURRENT_DATE - INTERVAL 600 DAY;
